...
switch ($API_type) {
	...
	echo "There is a bug in search func";
		break;
	case 'get_music_info':
    echo $_GET["callback"]."(".get_music_info($queryString['id']).")";
	...
	echo get_artist_album($queryString['id'],$queryString['limit']);
		break;
	case 'get_album_info':
    echo $_GET["callback"]."(".get_album_info($queryString['id']).")";
	//echo get_album_info($queryString['id']);
		break;
	case 'get_playlist_info':
	echo $_GET["callback"]."(".get_playlist_info($queryString['id']).")";
		break;
	case 'get_music_lyric':
	echo $_GET["callback"]."(".get_music_lyric($queryString['id']).")";
		break;
	case 'get_mv_info':
